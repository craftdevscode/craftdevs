...
add_filter('gt3/tgmpa_plugins', 'gt3_tgmpa_plugins');

function gt3_tgmpa_plugins(){
	/**
	...
	$plugins = array(
		...
		array(
			...
			'source'             => 'https://gt3accounts.com/update/tgm.php?eyJzIjoid3BkYS1idWlsZGVyLXBybyIsImEiOiJkb3dubG9hZF9wbHVnaW4ifQ==', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '1.2.17', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
		array(
			...
			'source'             => 'https://gt3accounts.com/update/tgm.php?eyJzIjoicmV2c2xpZGVyIiwiYSI6ImRvd25sb2FkX3BsdWdpbiJ9', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '6.6.15', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
		array(
		...
		array(
			...
			'source'             => 'https://gt3accounts.com/update/tgm.php?eyJzIjoiZ3QzLWVsZW1lbnRvci11bmxpbWl0ZWQtY2hhcnRzIiwiYSI6ImRvd25sb2FkX3BsdWdpbiJ9',
			'required'           => false,
			'version'            => '1.0.5',
		...
		array(
			...
			'source'             => 'https://gt3accounts.com/update/tgm.php?eyJzIjoiZ3QzLXBob3RvLXZpZGVvLWdhbGxlcnktcHJvIiwiYSI6ImRvd25sb2FkX3BsdWdpbiJ9', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '1.7.2.16', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		),
	);
...
function gt3_register_required_plugins(){
	...
	$plugins = apply_filters('gt3/tgmpa_plugins', array());
	...
	$config = array(
		...
		'strings'      => array(
			...
			'installing'                      => esc_html__('Installing Plugin: %s', 'ewebot'),
			// %s = plugin name.
			'oops'                            => esc_html__('Something went wrong with the plugin API.', 'ewebot'),
			'notice_can_install_required'     => esc_html__('This theme requires the following plugins: %1$s.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_can_install_recommended'  => esc_html__('This theme recommends the following plugins: %1$s.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_cannot_install'           => esc_html__('Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_can_activate_required'    => esc_html__('The following required plugins are currently inactive: %1$s.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_can_activate_recommended' => esc_html__('The following recommended plugins are currently inactive: %1$s.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_cannot_activate'          => esc_html__('Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_ask_to_update'            => esc_html__('The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'ewebot'),
			// %1$s = plugin name(s).
			'notice_cannot_update'            => esc_html__('Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.', 'ewebot'),
			// %1$s = plugin name(s).
			...
			'complete'                        => esc_html__('All plugins installed and activated successfully. %s', 'ewebot'),
			// %s = dashboard link.
			'nag_type'                        => 'updated'
...
add_filter('gt3/core/dashboard/tgm/plugins', function($plugins) {
	return array(
		'gt3-themes-core',
		'wpda-builder-pro'
	);
